...
const AboutSection = () => {
  ...
  return (
    <Element name="About">
      <section
        className="dark:text-white text-black flex flex-col justify-center items-center md:h-screen pt-12"
        id="about"
        name="about"
      >
        ...
        <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 justify-center">
          <Image
            ...
            height={400}
          />
          <div className="mt-4 md:mt-0 text-left flex flex-col h-full md:justify-around">
            <p className="text-base lg:text-lg text-justify dark:text-cardText text-slate-700">
